...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            //method to login (volley)
            // create a map with the payload content to be sent to the service
            ...
            // gives verb, url,
            JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.POST, url + "/users/login", new JSONObject(jsonParams),
